...
prompt_user = sprintf([
    ...
    '  [1] Download newdata -> raw & schedule scans to process\n', ...
    '  [2] Preview scheduled scans to process\n', ...
...
switch action
    ...
    case 7
        ...
        if ~metadata_uploaded
            fprintf([
                ...
                'internal ROI extractions. See "LEADS-SOP_External-File-Downloads.docx"\n', ...
    ...
    case 8
        ...
        if ~metadata_uploaded
            fprintf([
                'Please download the latest versions of these files before compiling\n', ...
                'quarterly report files. See "LEADS-SOP_External-File-Downloads.docx"\n', ...
                'for detailed instructions. Bye for now...\n\n'
            ]);
            return;
        end
