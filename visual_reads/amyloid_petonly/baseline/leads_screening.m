%%% Master script to deal with prospective images within LEADS project.
%%% Leonardo Iaccarino, UCSF - Leonardo.Iaccarino@ucsf.edu
%%% Beta 1.0.1. April 28 2018
%%% v1.0.2. May 29 to add labels to JPG output and solve Printing to table
%%% of strings
%%% v1.0.3. Dec 16 to analyze and create automatically folders for the
%%% reads, with also quantification csv
%%% v1.0.4. Mar 19 to move all the processing in the shared petcore system
%%% Sep 2021: Code Cleanup

% Commented this out and added to startup.m script
...
addpath('/mnt/coredata/Projects/LEADS/screening/service/');

%%% Create some variables we will use later, dirs template and ROIs
scrdir='/shared/petcore/Projects/LEADS/screening/scr_folders/';
dwndir='/mnt/coredata/Projects/LEADS/screening/new_downloads/';
db_file = '/mnt/coredata/Projects/LEADS/screening/Database_LEADS.csv';
fbbtemplate = '/mnt/coredata/Projects/LEADS/screening/service/TemplateFBB_ADNI72_s8mm.nii';
rois={'/mnt/coredata/Projects/LEADS/screening/service/ROI/Cingulate.nii', ...
    '/mnt/coredata/Projects/LEADS/screening/service/ROI/Frontal.nii', ...
    '/mnt/coredata/Projects/LEADS/screening/service/ROI/Parietal.nii', ...
    '/mnt/coredata/Projects/LEADS/screening/service/ROI/Temporal.nii', ...
    '/mnt/coredata/Projects/LEADS/screening/service/ROI/WholeCerebellum.nii'}';
...
newdb={};
    ...
    cd('/mnt/coredata/Projects/LEADS/screening/')
    ...
    clear dcmdir newscrdir temp_img oldfname newfname new_wimg img imgv tvals dems demstvals acq_date quant quantfile suvr_wfname exp suvr_fname
...
writetable(finaltable,'/mnt/coredata/Projects/LEADS/screening/Database_LEADS.csv') %% overwrite Database
