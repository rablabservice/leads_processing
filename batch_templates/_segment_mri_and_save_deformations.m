...
matlabbatch{2}.spm.spatial.smooth.data(1) = cfg_dep('Segment: mwc1 Images', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','tiss', '()',{1}, '.','mwc', '()',{':'}));
matlabbatch{2}.spm.spatial.smooth.fwhm = [fwhm fwfm fwhm];
